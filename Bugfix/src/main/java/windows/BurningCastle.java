...
public class BurningCastle extends javax.swing.JFrame {

    public BurningCastle() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("BUGFIX: Burning Castle");
        setLocation(new java.awt.Point(450, 0));
        setResizable(false);

        jLabel1.setIcon(new ImageIcon("img/burningCastle.png"));
    ...
    public static void run() {
        try {
            ...
            java.util.logging.Logger.getLogger(BurningCastle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        new BurningCastle().setVisible(true);
    }
